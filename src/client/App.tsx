...
export default function App() {
  ...
  return (
    <div id="app">
      ...
      {view === Page.Device && device && <Device device={device} setDevice={setDevice} setView={setView} />}
      {view === Page.Settings && device && <Settings device={device} setDevice={setDevice} setView={setView} />}
    </div>
  );
}
